...
-- helper function to get the value at a given position in the array
...
for x = 1, #arr do
    for y = 1, #arr[1] do
        ...
        -- if there are no values equal to or greater than the target value in a given direction,
        -- use the distance to the outer bound of the array instead
        if left_dist == 0 then
            left_dist = y - 1
        end
